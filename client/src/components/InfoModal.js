    ...
    return (
        ...
        <Modal show={showModals[1]} onHide={closeModal} size='md'>
            ...
            <Modal.Body className='fs-5'>
                ...
                <svg onMouseOver={hoverColor} onMouseOut={defaultColor} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" className="bi bi-github" viewBox="0 0 16 16">
